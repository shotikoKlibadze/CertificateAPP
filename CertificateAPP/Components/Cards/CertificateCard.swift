...
struct CertificateCard: View {
    ...
    var body: some View {
        ...
        .background(
            RadialGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.9921568627, green: 0.2470588235, blue: 0.2, alpha: 0.8)), Color(#colorLiteral(red: 0.2980392157, green: 0, blue: 0.7843137255, alpha: 0.6))]), center: .bottomTrailing, startRadius: 5, endRadius: 900)
        )
        .overlay(
